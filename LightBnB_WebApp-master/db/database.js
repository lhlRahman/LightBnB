...
if (options.minimum_price_per_night && options.maximum_price_per_night) {
  queryParams.push(Number(options.minimum_price_per_night)); // Using the provided value directly
  queryParams.push(Number(options.maximum_price_per_night)); // Using the provided value directly
